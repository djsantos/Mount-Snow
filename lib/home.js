 module.exports = {
	...
	getTweetFeed:getTweetFeed
};

//returns number of times user has tweeted
function numTweets(){
	var result = 5;
	return result;
}

//returns number of followers a user has
function numFollowers(){
	var result = 12;
	return result;
}

//returns number of people a user is following
...
//returns an array of tweets for the feed
