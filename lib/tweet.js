...
if(!uid2)
	uid2 = uid;//id of reciever of tweet (may not be different from sender)
this.username = user.getUsername(uid);//username of sender of tweet
this.username2 = user.getUsername(uid2);//username of reciever of tweet (may not be different from sender)
}
